  ...
  var game = {
    ...
    loop: function () {
      ...
      if (!stopped) {
        ...
        ctx.fillText("(esc) recomeçar", 24, 356);
      ...
      if (stopped) {
        ...
        ctx.fillText("pressione as setas para começar!", 24, 374);
      }

      ctx.fillStyle = 'white';
      ctx.font = "bold small-caps 16px Helvetica";
      ctx.fillText("pontuação: " + points, 288, 40);
      ctx.fillText("recorde: " + pointsMax, 292, 60);
